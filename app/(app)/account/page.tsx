        ...
        <GrowthCard className="flex flex-col gap-3">
          ...
          {business.loyalty_discount_available && (
            <p className="text-sm text-emerald-700">
              🎁 Tienes un 5% de descuento para tu próxima compra — se aplica solo, tanto si compras un plan
              o una mejora como si cambias de plan desde &quot;Gestionar suscripción&quot;.
            </p>
          )}
        </GrowthCard>
    ...
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 px-6 py-12">
      ...
      <DashboardTabs
        tabs={[
          ...
          { id: "negocio", label: "🏪 Negocio", content: businessTab },
          { id: "facturacion", label: "💳 Facturación", content: billingTab },
          { id: "seguridad", label: "🔒 Seguridad", content: securityTab },
        ]}
      />
    </div>
  );
