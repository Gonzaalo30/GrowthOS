              ...
              <AnimatePresence>
                {switcherOpen && (
                  <motion.div
                    ...
                    className="absolute left-0 top-10 z-10 w-64 rounded-xl border border-border bg-white p-2 shadow-lg"
                  >
            ...
            <AnimatePresence>
              {bellOpen && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -4, scale: 0.98 }}
                  transition={{ duration: 0.15 }}
                  className="absolute right-0 top-11 z-10 w-72 rounded-xl border border-border bg-white p-2 shadow-lg"
                >
